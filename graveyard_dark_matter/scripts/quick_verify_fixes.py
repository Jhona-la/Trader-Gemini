...
print(f"   ML Accuracy: {r2['ml_accuracy']:.1f}%")
print(f"   Gate Active: {r2['accuracy_gate_active']}")
print(f"   Gate Blocks: {r2['accuracy_gate_blocks']}")
print(f"   ML Trainings: {r2['ml_trainings']}")
