...
def run_simulation_batch(batch_idx, num_candles, num_estrategias):
    ...
    # MOCKS para demostrar la integración Vectorizada C++/Numba
    # Simularemos señales aleatorias y un Random Walk de precio
    prices = np.cumprod(1 + np.random.normal(0, 0.001, num_candles))
