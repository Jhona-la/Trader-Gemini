...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "core.quantum.ml_bridge",
        "sources": [
            "core\\quantum\\ml_bridge.py"
        ]
    },
    "module_name": "core.quantum.ml_bridge"
}
END: Cython Metadata */
...
#define __PYX_HAVE__core__quantum__ml_bridge
#define __PYX_HAVE_API__core__quantum__ml_bridge
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "core.quantum.ml_bridge" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "core.quantum.ml_bridge"
extern int __pyx_module_is_main_core__quantum__ml_bridge;
int __pyx_module_is_main_core__quantum__ml_bridge = 0;

/* Implementation of "core.quantum.ml_bridge" */
...
static int __pyx_pymod_exec_ml_bridge(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ml_bridge},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_ml_bridge(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ml_bridge(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ml_bridge(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ml_bridge' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "ml_bridge" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_ml_bridge", 0);
  ...
  if (__pyx_module_is_main_core__quantum__ml_bridge) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "core.quantum.ml_bridge")) {
      if (unlikely((PyDict_SetItemString(modules, "core.quantum.ml_bridge", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init core.quantum.ml_bridge", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init core.quantum.ml_bridge");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
