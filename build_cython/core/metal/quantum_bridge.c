...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "core.metal.quantum_bridge",
        "sources": [
            "core\\metal\\quantum_bridge.pyx"
        ]
    },
    "module_name": "core.metal.quantum_bridge"
}
END: Cython Metadata */
...
#define __PYX_HAVE_API__core__metal__quantum_bridge
/* Early includes */
#include "quantum_oracle.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "core.metal.quantum_bridge" */
__PYX_EXTERN_C int py_validate_topological_integrity(struct QuantumStateArena const *, size_t); /*proto*/
__PYX_EXTERN_C void fire_oracle(struct QuantumStateArena const *, struct TradeDecision *); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "core.metal.quantum_bridge"
extern int __pyx_module_is_main_core__metal__quantum_bridge;
int __pyx_module_is_main_core__metal__quantum_bridge = 0;

/* Implementation of "core.metal.quantum_bridge" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_4core_5metal_14quantum_bridge_fire_oracle_wrapped(CYTHON_UNUSED PyObject *__pyx_self, size_t __pyx_v_arena_ptr, size_t __pyx_v_decision_ptr); /* proto */
...
#define __pyx_kp_u_core_metal_quantum_bridge_pyx __pyx_string_tab[1]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[2]
#define __pyx_n_u_arena __pyx_string_tab[3]
#define __pyx_n_u_arena_ptr __pyx_string_tab[4]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[5]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[6]
#define __pyx_n_u_core_metal_quantum_bridge __pyx_string_tab[7]
#define __pyx_n_u_decision __pyx_string_tab[8]
#define __pyx_n_u_decision_ptr __pyx_string_tab[9]
#define __pyx_n_u_fire_oracle_wrapped __pyx_string_tab[10]
...
#define __pyx_kp_b_iso88591_8_31_1G1 __pyx_string_tab[23]
...
/* "core/metal/quantum_bridge.pyx":5
...
int py_validate_topological_integrity(struct QuantumStateArena const *__pyx_v_arena, size_t __pyx_v_stride_bytes) {
  int __pyx_r;

  /* "core/metal/quantum_bridge.pyx":9
 *     Python-facing wrapper for handshake
 *     """
...
*/
  __pyx_r = validate_topological_integrity(__pyx_v_arena, __pyx_v_stride_bytes);
  goto __pyx_L0;
...
/* "core/metal/quantum_bridge.pyx":11
 *     return validate_topological_integrity(arena, stride_bytes)
 * 
 * cdef public void fire_oracle(const QuantumStateArena* arena, TradeDecision* out_decision) nogil:             # <<<<<<<<<<<<<<
 *     """
 *     MEMBRANA FFI: Libera el GIL y delega todo el poder de cmputo al Hyper-Kernel nativo.
*/

void fire_oracle(struct QuantumStateArena const *__pyx_v_arena, struct TradeDecision *__pyx_v_out_decision) {

  /* "core/metal/quantum_bridge.pyx":16
...
*/
  execute_oracle_kernel(__pyx_v_arena, __pyx_v_out_decision);
...
/* "core/metal/quantum_bridge.pyx":18
 *     execute_oracle_kernel(arena, out_decision)
 * 
 * def fire_oracle_wrapped(size_t arena_ptr, size_t decision_ptr):             # <<<<<<<<<<<<<<
 *     """
...
/* Python wrapper */
static PyObject *__pyx_pw_4core_5metal_14quantum_bridge_1fire_oracle_wrapped(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_4core_5metal_14quantum_bridge_1fire_oracle_wrapped = {"fire_oracle_wrapped", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4core_5metal_14quantum_bridge_1fire_oracle_wrapped, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4core_5metal_14quantum_bridge_1fire_oracle_wrapped(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  size_t __pyx_v_arena_ptr;
  size_t __pyx_v_decision_ptr;
  #if !CYTHON_METH_FASTCALL
  ...
  __Pyx_RefNannySetupContext("fire_oracle_wrapped (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_arena_ptr,&__pyx_mstate_global->__pyx_n_u_decision_ptr,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "fire_oracle_wrapped", 0) < (0)) __PYX_ERR(0, 18, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("fire_oracle_wrapped", 1, 2, 2, i); __PYX_ERR(0, 18, __pyx_L3_error) }
      }
    ...
    __pyx_v_arena_ptr = __Pyx_PyLong_As_size_t(values[0]); if (unlikely((__pyx_v_arena_ptr == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_decision_ptr = __Pyx_PyLong_As_size_t(values[1]); if (unlikely((__pyx_v_decision_ptr == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fire_oracle_wrapped", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 18, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("core.metal.quantum_bridge.fire_oracle_wrapped", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4core_5metal_14quantum_bridge_fire_oracle_wrapped(__pyx_self, __pyx_v_arena_ptr, __pyx_v_decision_ptr);
...
static PyObject *__pyx_pf_4core_5metal_14quantum_bridge_fire_oracle_wrapped(CYTHON_UNUSED PyObject *__pyx_self, size_t __pyx_v_arena_ptr, size_t __pyx_v_decision_ptr) {
  struct QuantumStateArena *__pyx_v_arena;
  struct TradeDecision *__pyx_v_decision;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("fire_oracle_wrapped", 0);

  /* "core/metal/quantum_bridge.pyx":22
 *     Wrapper para ser llamado desde ctypes en Python pasando los punteros en crudo.
 *     """
 ...
 * 
*/
  __pyx_v_arena = ((struct QuantumStateArena *)__pyx_v_arena_ptr);

  /* "core/metal/quantum_bridge.pyx":23
 *     """
 *     cdef QuantumStateArena* arena = <QuantumStateArena*>arena_ptr
 *     cdef TradeDecision* decision = <TradeDecision*>decision_ptr             # <<<<<<<<<<<<<<
 * 
 *     # Soltamos el GIL justo antes de la invocacin en C/Rust
*/
  __pyx_v_decision = ((struct TradeDecision *)__pyx_v_decision_ptr);

  /* "core/metal/quantum_bridge.pyx":26
 * 
 *     # Soltamos el GIL justo antes de la invocacin en C/Rust
 *     with nogil:             # <<<<<<<<<<<<<<
...
*/
  {
      ...
      /*try:*/ {
        ...
        /* "core/metal/quantum_bridge.pyx":27
 *     # Soltamos el GIL justo antes de la invocacin en C/Rust
 *     with nogil:
 *         fire_oracle(arena, decision)             # <<<<<<<<<<<<<<
*/
        fire_oracle(__pyx_v_arena, __pyx_v_decision); if (unlikely(__Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 27, __pyx_L4_error)
      }
...
static int __pyx_pymod_exec_quantum_bridge(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_quantum_bridge},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_quantum_bridge(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_quantum_bridge(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_quantum_bridge(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'quantum_bridge' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "quantum_bridge" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_quantum_bridge", 0);
  ...
  if (__pyx_module_is_main_core__metal__quantum_bridge) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "core.metal.quantum_bridge")) {
      if (unlikely((PyDict_SetItemString(modules, "core.metal.quantum_bridge", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     Wrapper para ser llamado desde ctypes en Python pasando los punteros en crudo.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4core_5metal_14quantum_bridge_1fire_oracle_wrapped, 0, __pyx_mstate_global->__pyx_n_u_fire_oracle_wrapped, NULL, __pyx_mstate_global->__pyx_n_u_core_metal_quantum_bridge, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_fire_oracle_wrapped, __pyx_t_2) < (0)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "core/metal/quantum_bridge.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init core.metal.quantum_bridge", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init core.metal.quantum_bridge");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{29},{20},{5},{9},{18},{18},{25},{8},{12},{19},{8},{13},{5},{8},{10},{8},{3},{12},{12},{10},{8},{6},{34}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd