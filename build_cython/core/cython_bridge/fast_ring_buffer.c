...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "core.cython_bridge.fast_ring_buffer",
        "sources": [
            "core\\cython_bridge\\fast_ring_buffer.py"
        ]
    },
    "module_name": "core.cython_bridge.fast_ring_buffer"
}
END: Cython Metadata */
...
#define __PYX_HAVE__core__cython_bridge__fast_ring_buffer
#define __PYX_HAVE_API__core__cython_bridge__fast_ring_buffer
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "core.cython_bridge.fast_ring_buffer" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "core.cython_bridge.fast_ring_buffer"
extern int __pyx_module_is_main_core__cython_bridge__fast_ring_buffer;
int __pyx_module_is_main_core__cython_bridge__fast_ring_buffer = 0;

/* Implementation of "core.cython_bridge.fast_ring_buffer" */
...
static int __pyx_pymod_exec_fast_ring_buffer(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fast_ring_buffer},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_fast_ring_buffer(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fast_ring_buffer(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fast_ring_buffer(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fast_ring_buffer' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "fast_ring_buffer" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_fast_ring_buffer", 0);
  ...
  if (__pyx_module_is_main_core__cython_bridge__fast_ring_buffer) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "core.cython_bridge.fast_ring_buffer")) {
      if (unlikely((PyDict_SetItemString(modules, "core.cython_bridge.fast_ring_buffer", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "core/cython_bridge/fast_ring_buffer.py":1
             # <<<<<<<<<<<<<<
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init core.cython_bridge.fast_ring_buffer", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init core.cython_bridge.fast_ring_buffer");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    ...
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (64 bytes) */
const char* const cstring = "x\332%\207Q\016\2000\010\305\216\346Q^\220=\223E\300\270\301\375\235\332\237\266\233Z\017\242\007r\210r\027=\001\227\365\013\277Z\031\337\n\361\317w\211\375=\231\215\207\224%\220\234\t<i\203\035\375";
    PyObject *data = __Pyx_DecompressString(cstring, 64, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (75 bytes) */
