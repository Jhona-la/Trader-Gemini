...
impl SuperGenotype {
    ...
    pub fn get_lower_bounds() -> Vec<f64> {
        vec![
            0.5, 25.0, 0.5, 0.5, 1.0, 0.5, 0.1, 0.2, 0.1, 0.1, 0.1, 0.01, 0.05, 0.0010, 0.0010,
            0.0100, 0.0050, 0.5, 1.0, 0.5, 0.5, 0.001, 0.5, 0.5, 0.0001, 0.1, 0.005, 0.0001, 0.05,
            ...
            0.05, 0.01, 0.1, 0.10, 0.05, 0.01, 1.0, 1.01, 10.0, 0.1, 0.1, 100.0, 10000.0, 1.0, 1.0,
