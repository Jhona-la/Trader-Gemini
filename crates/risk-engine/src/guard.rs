...
#[inline(always)]
pub fn check_drawdown_limit(current_capital: f64, peak_capital: f64, genome_max_drawdown_pct: f64, base_capital: f64, guard_dd_sigmoid_steepness: f64, guard_dd_sigmoid_center: f64) -> bool {
    if peak_capital <= 0.0 {
    ...
    let dynamic_max_drawdown = genome_max_drawdown_pct + (0.99 - genome_max_drawdown_pct) * sigmoid_val;
