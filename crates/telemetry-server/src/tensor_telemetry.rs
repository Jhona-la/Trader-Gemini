...
impl TensorTelemetryRing {
    pub const fn new() -> Self {
        Self {
            ...
            slots: [
                Slot::new(0), Slot::new(1), Slot::new(2), Slot::new(3),
                Slot::new(4), Slot::new(5), Slot::new(6), Slot::new(7),
                Slot::new(8), Slot::new(9), Slot::new(10), Slot::new(11),
                Slot::new(12), Slot::new(13), Slot::new(14), Slot::new(15),
                Slot::new(16), Slot::new(17), Slot::new(18), Slot::new(19),
                Slot::new(20), Slot::new(21), Slot::new(22), Slot::new(23),
                Slot::new(24), Slot::new(25), Slot::new(26), Slot::new(27),
                Slot::new(28), Slot::new(29), Slot::new(30), Slot::new(31),
                Slot::new(32), Slot::new(33), Slot::new(34), Slot::new(35),
                Slot::new(36), Slot::new(37), Slot::new(38), Slot::new(39),
                Slot::new(40), Slot::new(41), Slot::new(42), Slot::new(43),
                Slot::new(44), Slot::new(45), Slot::new(46), Slot::new(47),
                Slot::new(48), Slot::new(49), Slot::new(50), Slot::new(51),
                Slot::new(52), Slot::new(53), Slot::new(54), Slot::new(55),
                Slot::new(56), Slot::new(57), Slot::new(58), Slot::new(59),
                Slot::new(60), Slot::new(61), Slot::new(62), Slot::new(63),
                Slot::new(64), Slot::new(65), Slot::new(66), Slot::new(67),
                Slot::new(68), Slot::new(69), Slot::new(70), Slot::new(71),
                Slot::new(72), Slot::new(73), Slot::new(74), Slot::new(75),
                Slot::new(76), Slot::new(77), Slot::new(78), Slot::new(79),
                Slot::new(80), Slot::new(81), Slot::new(82), Slot::new(83),
                Slot::new(84), Slot::new(85), Slot::new(86), Slot::new(87),
                Slot::new(88), Slot::new(89), Slot::new(90), Slot::new(91),
                Slot::new(92), Slot::new(93), Slot::new(94), Slot::new(95),
                Slot::new(96), Slot::new(97), Slot::new(98), Slot::new(99),
                Slot::new(100), Slot::new(101), Slot::new(102), Slot::new(103),
                Slot::new(104), Slot::new(105), Slot::new(106), Slot::new(107),
                Slot::new(108), Slot::new(109), Slot::new(110), Slot::new(111),
                Slot::new(112), Slot::new(113), Slot::new(114), Slot::new(115),
                Slot::new(116), Slot::new(117), Slot::new(118), Slot::new(119),
                Slot::new(120), Slot::new(121), Slot::new(122), Slot::new(123),
                Slot::new(124), Slot::new(125), Slot::new(126), Slot::new(127),
            ],
        }
    }
    ...
    pub fn push_tensor(&self, timestamp_ms: u64, features: &[f64; 54]) -> Result<(), ()> {
        ...
        for i in 0..54 {
            safe_features[i] = if features[i].is_finite() { features[i] } else { 0.0 };
        }
