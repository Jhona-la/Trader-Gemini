...
#define __PYX_HAVE__risk__c_risk
#define __PYX_HAVE_API__risk__c_risk
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "risk.c_risk" */
static double __pyx_f_4risk_6c_risk_compute_kelly_fraction(double, double, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_4risk_6c_risk_compute_dynamic_sizing(double, double, double, double, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_4risk_6c_risk_check_drawdown_limit(double, double, double, int __pyx_skip_dispatch); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "risk.c_risk"
extern int __pyx_module_is_main_risk__c_risk;
int __pyx_module_is_main_risk__c_risk = 0;

/* Implementation of "risk.c_risk" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_4risk_6c_risk_compute_kelly_fraction(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_win_rate, double __pyx_v_win_loss_ratio); /* proto */
static PyObject *__pyx_pf_4risk_6c_risk_2compute_dynamic_sizing(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_current_balance, double __pyx_v_kelly_fraction, double __pyx_v_max_risk_limit, double __pyx_v_atr_pct); /* proto */
static PyObject *__pyx_pf_4risk_6c_risk_4check_drawdown_limit(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_peak_balance, double __pyx_v_current_balance, double __pyx_v_max_dd_pct); /* proto */
...
#define __pyx_kp_u_risk_c_risk_pyx __pyx_string_tab[1]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[2]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[3]
#define __pyx_n_u_atr_pct __pyx_string_tab[4]
#define __pyx_n_u_check_drawdown_limit __pyx_string_tab[5]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[6]
#define __pyx_n_u_compute_dynamic_sizing __pyx_string_tab[7]
#define __pyx_n_u_compute_kelly_fraction __pyx_string_tab[8]
#define __pyx_n_u_current_balance __pyx_string_tab[9]
...
#define __pyx_n_u_kelly_fraction __pyx_string_tab[13]
#define __pyx_n_u_main __pyx_string_tab[14]
#define __pyx_n_u_max_dd_pct __pyx_string_tab[15]
#define __pyx_n_u_max_risk_limit __pyx_string_tab[16]
#define __pyx_n_u_module __pyx_string_tab[17]
#define __pyx_n_u_name __pyx_string_tab[18]
#define __pyx_n_u_peak_balance __pyx_string_tab[19]
#define __pyx_n_u_pop __pyx_string_tab[20]
#define __pyx_n_u_qualname __pyx_string_tab[21]
#define __pyx_n_u_risk_c_risk __pyx_string_tab[22]
...
#define __pyx_n_u_win_loss_ratio __pyx_string_tab[27]
#define __pyx_n_u_win_rate __pyx_string_tab[28]
#define __pyx_kp_b_iso88591_Cq_q_m2_6b_s_Q_q_1 __pyx_string_tab[29]
#define __pyx_kp_b_iso88591_b_3_b_b_xs_q_Ba_1 __pyx_string_tab[30]
#define __pyx_kp_b_iso88591_c_S_A_q_D_IS_A_r_1_q_1 __pyx_string_tab[31]
...
static PyObject *__pyx_pw_4risk_6c_risk_1compute_kelly_fraction(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_4risk_6c_risk_compute_kelly_fraction(double __pyx_v_win_rate, double __pyx_v_win_loss_ratio, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_q;
  double __pyx_v_k;
  double __pyx_r;
  int __pyx_t_1;
 ...
 * 
*/
  __pyx_t_2 = (__pyx_v_win_loss_ratio <= 0.0);
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_2 = (__pyx_v_win_rate <= 0.0);
  __pyx_t_1 = __pyx_t_2;
 ...
 * 
*/
  __pyx_v_q = (1.0 - __pyx_v_win_rate);
 ...
 *     if k < 0.0:
*/
  __pyx_v_k = (__pyx_v_win_rate - (__pyx_v_q / __pyx_v_win_loss_ratio));
...
PyDoc_STRVAR(__pyx_doc_4risk_6c_risk_compute_kelly_fraction, "\n    Cython implementation of the Kelly Criterion.\n    win_rate: Decimal (e.g. 0.55 for 55%)\n    win_loss_ratio: Reward/Risk ratio (e.g. 1.5)\n    Returns fraction to risk (e.g. 0.25 for 25%).\n    ");
static PyMethodDef __pyx_mdef_4risk_6c_risk_1compute_kelly_fraction = {"compute_kelly_fraction", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4risk_6c_risk_1compute_kelly_fraction, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_4risk_6c_risk_compute_kelly_fraction};
static PyObject *__pyx_pw_4risk_6c_risk_1compute_kelly_fraction(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("compute_kelly_fraction (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "compute_kelly_fraction", 0) < (0)) __PYX_ERR(0, 6, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("compute_kelly_fraction", 1, 2, 2, i); __PYX_ERR(0, 6, __pyx_L3_error) }
      }
    ...
    __pyx_v_win_rate = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_win_rate == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_win_loss_ratio = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_win_loss_ratio == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute_kelly_fraction", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("risk.c_risk.compute_kelly_fraction", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4risk_6c_risk_compute_kelly_fraction(__pyx_self, __pyx_v_win_rate, __pyx_v_win_loss_ratio);
...
static PyObject *__pyx_pf_4risk_6c_risk_compute_kelly_fraction(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_win_rate, double __pyx_v_win_loss_ratio) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("compute_kelly_fraction", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4risk_6c_risk_compute_kelly_fraction(__pyx_v_win_rate, __pyx_v_win_loss_ratio, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L1_error)
...
static PyObject *__pyx_pw_4risk_6c_risk_3compute_dynamic_sizing(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static double __pyx_f_4risk_6c_risk_compute_dynamic_sizing(double __pyx_v_current_balance, double __pyx_v_kelly_fraction, double __pyx_v_max_risk_limit, double __pyx_v_atr_pct, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_risk_budget;
...
*/
  __pyx_v_risk_budget = (__pyx_v_current_balance * __pyx_v_kelly_fraction);
 ...
 * 
*/
  __pyx_t_1 = (__pyx_v_risk_budget > (__pyx_v_current_balance * __pyx_v_max_risk_limit));
  if (__pyx_t_1) {
...
*/
    __pyx_v_risk_budget = (__pyx_v_current_balance * __pyx_v_max_risk_limit);
 ...
 * 
*/
  __pyx_v_position_size = (__pyx_v_risk_budget / __pyx_v_atr_pct);
...
PyDoc_STRVAR(__pyx_doc_4risk_6c_risk_2compute_dynamic_sizing, "\n    Computes absolute position size in USDT based on:\n    - current balance\n    - computed kelly fraction\n    - the maximum allowable risk\n    - current ATR (volatility measure)\n    ");
static PyMethodDef __pyx_mdef_4risk_6c_risk_3compute_dynamic_sizing = {"compute_dynamic_sizing", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4risk_6c_risk_3compute_dynamic_sizing, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_4risk_6c_risk_2compute_dynamic_sizing};
static PyObject *__pyx_pw_4risk_6c_risk_3compute_dynamic_sizing(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("compute_dynamic_sizing (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_current_balance,&__pyx_mstate_global->__pyx_n_u_kelly_fraction,&__pyx_mstate_global->__pyx_n_u_max_risk_limit,&__pyx_mstate_global->__pyx_n_u_atr_pct,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "compute_dynamic_sizing", 0) < (0)) __PYX_ERR(0, 25, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 4; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("compute_dynamic_sizing", 1, 4, 4, i); __PYX_ERR(0, 25, __pyx_L3_error) }
      }
    ...
    __pyx_v_current_balance = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_current_balance == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
    __pyx_v_kelly_fraction = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_kelly_fraction == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
    __pyx_v_max_risk_limit = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_max_risk_limit == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
    __pyx_v_atr_pct = __Pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_atr_pct == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute_dynamic_sizing", 1, 4, 4, __pyx_nargs); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("risk.c_risk.compute_dynamic_sizing", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4risk_6c_risk_2compute_dynamic_sizing(__pyx_self, __pyx_v_current_balance, __pyx_v_kelly_fraction, __pyx_v_max_risk_limit, __pyx_v_atr_pct);
...
static PyObject *__pyx_pf_4risk_6c_risk_2compute_dynamic_sizing(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_current_balance, double __pyx_v_kelly_fraction, double __pyx_v_max_risk_limit, double __pyx_v_atr_pct) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("compute_dynamic_sizing", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4risk_6c_risk_compute_dynamic_sizing(__pyx_v_current_balance, __pyx_v_kelly_fraction, __pyx_v_max_risk_limit, __pyx_v_atr_pct, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L1_error)
...
static PyObject *__pyx_pw_4risk_6c_risk_5check_drawdown_limit(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static int __pyx_f_4risk_6c_risk_check_drawdown_limit(double __pyx_v_peak_balance, double __pyx_v_current_balance, double __pyx_v_max_dd_pct, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_dd;
  int __pyx_r;
  int __pyx_t_1;
 ...
 * 
*/
  __pyx_t_1 = (__pyx_v_peak_balance <= 0.0);
  if (__pyx_t_1) {
 ...
 *         return 1
*/
  __pyx_v_dd = ((__pyx_v_peak_balance - __pyx_v_current_balance) / __pyx_v_peak_balance);
 ...
 *     return 0
*/
  __pyx_t_1 = (__pyx_v_dd >= __pyx_v_max_dd_pct);
  if (__pyx_t_1) {
...
PyDoc_STRVAR(__pyx_doc_4risk_6c_risk_4check_drawdown_limit, "\n    Returns 1 if drawdown limit is exceeded, 0 otherwise.\n    ");
static PyMethodDef __pyx_mdef_4risk_6c_risk_5check_drawdown_limit = {"check_drawdown_limit", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4risk_6c_risk_5check_drawdown_limit, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_4risk_6c_risk_4check_drawdown_limit};
static PyObject *__pyx_pw_4risk_6c_risk_5check_drawdown_limit(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("check_drawdown_limit (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_peak_balance,&__pyx_mstate_global->__pyx_n_u_current_balance,&__pyx_mstate_global->__pyx_n_u_max_dd_pct,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "check_drawdown_limit", 0) < (0)) __PYX_ERR(0, 47, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("check_drawdown_limit", 1, 3, 3, i); __PYX_ERR(0, 47, __pyx_L3_error) }
      }
    ...
    __pyx_v_peak_balance = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_peak_balance == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
    __pyx_v_current_balance = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_current_balance == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
    __pyx_v_max_dd_pct = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_max_dd_pct == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("check_drawdown_limit", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 47, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("risk.c_risk.check_drawdown_limit", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4risk_6c_risk_4check_drawdown_limit(__pyx_self, __pyx_v_peak_balance, __pyx_v_current_balance, __pyx_v_max_dd_pct);
...
static PyObject *__pyx_pf_4risk_6c_risk_4check_drawdown_limit(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_peak_balance, double __pyx_v_current_balance, double __pyx_v_max_dd_pct) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("check_drawdown_limit", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4risk_6c_risk_check_drawdown_limit(__pyx_v_peak_balance, __pyx_v_current_balance, __pyx_v_max_dd_pct, 1); if (unlikely(__pyx_t_1 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 47, __pyx_L1_error)
...
static int __pyx_pymod_exec_c_risk(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_c_risk},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_c_risk(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_c_risk(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_c_risk(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'c_risk' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "c_risk" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_c_risk", 0);
  ...
  if (__pyx_module_is_main_risk__c_risk) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "risk.c_risk")) {
      if (unlikely((PyDict_SetItemString(modules, "risk.c_risk", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * cpdef double compute_kelly_fraction(double win_rate, double win_loss_ratio):
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4risk_6c_risk_1compute_kelly_fraction, 0, __pyx_mstate_global->__pyx_n_u_compute_kelly_fraction, NULL, __pyx_mstate_global->__pyx_n_u_risk_c_risk, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_compute_kelly_fraction, __pyx_t_2) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 * cpdef double compute_dynamic_sizing(double current_balance, double kelly_fraction, double max_risk_limit, double atr_pct):
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4risk_6c_risk_3compute_dynamic_sizing, 0, __pyx_mstate_global->__pyx_n_u_compute_dynamic_sizing, NULL, __pyx_mstate_global->__pyx_n_u_risk_c_risk, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_compute_dynamic_sizing, __pyx_t_2) < (0)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * cpdef int check_drawdown_limit(double peak_balance, double current_balance, double max_dd_pct):
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4risk_6c_risk_5check_drawdown_limit, 0, __pyx_mstate_global->__pyx_n_u_check_drawdown_limit, NULL, __pyx_mstate_global->__pyx_n_u_risk_c_risk, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_check_drawdown_limit, __pyx_t_2) < (0)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init risk.c_risk", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init risk.c_risk");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{15},{20},{18},{7},{20},{18},{22},{22},{15},{8},{13},{5},{14},{8},{10},{14},{10},{8},{12},{3},{12},{11},{12},{10},{8},{6},{14},{8},{54},{71},{70}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (407 bytes) */
const char* const cstring = "(\265/\375`\033\001m\014\000\366\326O-Pw\0160\3052\211\252\262r9>\266;>\352:\2705\0217\366\312\336[lIR\016\312\375x\375Hn\026\205\250\376\224N\336\377Y\217@\000=\000C\000!\276_\306\327\354\277\365\347\255E\334\365\250\305\3371\022\214]\023\374\020g\027\356\270|\263_\236\267\356'i\222xCj\274e\374\262\262\252\243\371\364\035\353\022*C\375\243\262r\363\230\023rm\206\002w\377\377g\361\004\311\216\313\007\301G\365\035\377\371\230\273~\256\377\037\357\223\365\237\361\276\342\375\276\357l\232'\336\244\356\370\232\254\227\211b\016[[\3174\177\254\307\273e\340\347~\226#\211\003\272/\007\312\354<\353\250F\006\274W\3128\264/\225\244\326n\007\002\340\320\233Hx\201[&u\277\346sN\212\277u\214\347S\274\260\377\316s\377\357\342yY\031\354\231?\026\357\371\372/\3112\274\271\374\317cm'u\244\246h\265\254\002S[\301\tp%\025\"b\037,b]\341 8\254\332\026\227\035\261\212\225RQy\212\026z\221C\033`\277U\023\331}T\032/\220\373\330\215d7!\000\032=\314\245\223&\006m*\275\244\374f\030\264\201\037( D@\335\231\007\260\354\2103\254\001\020V\330\257>\306&v\305\233\005S\254l\240;\205U\277ck\236\327\007J\255E\244\016[w\n\354\316\241\004\317\235iD\013\r#\307\025@\307\203\252\365\223N@[\302\024\305wD\035\027";
    PyObject *data = __Pyx_DecompressString(cstring, 407, 3);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (449 bytes) */
const char* const cstring = "BZh91AY&SY\216\330.'\000\000-\377\373\367\355\335\001\377\001\271\000\274!x\000\277\357\377\366\300@@@@@@@@@@\000@\0000\001x\333#\rM4\020LM2\236\223jh\001\243@\032\000\006\2004\364\233L\232\203U=5\r\246\210\003 \000\000\003@\006@\000i\352\0004&\243\0052h\206\232\001\241\240\032\000\000\006\206\201\223j6\244\215\214\327\251\307N\022Lt\344\310fFf&\002\253\004j\n\311J\244k\\\201\377BA\n\202K\026?NIj\213D.\207\334\027\360\034NP\034\375\273\324)\255&-\223p\320\030\224\2403\277\346i\362$g\321\3276\022br-`\3443c\203\t\270\2600+\322\"\010\020\324\345\300a\305J\021\3450\020;\230,\222J\005\316\250`\026\251\332i\005p\213\220\345+\036\0261\244&\010\245\373\315{:vJi\345C\035'\225Ng\331\030m\326\250\365'\031Na\022\030\330h\266%\2204\335\037\256BY\310<Fb\020j\031\312\301:\005\220+\025 \030\036\300-\006f\006\332E\234\313\211\355\326\214\0029\240@\347\230 \266\202\024\005\264\352\304\367\214\346]\026\014\254\213\201C\342\221\220\203\342\346(f\211\2104\010\232\241+a\335\221\311\037\235\325\2550\004\300\371\205\204\221\035N\306\253\214\230[\016.\003\027A\210#\246\320\264\341\275\023\020\334#\300t\021\r7|\221\217\0264\013\313\257G\300\263\256\2547\375\353m\203\365X2\346\035\343%\024h\347]e\\\224\327\237\233\210\252\301e\212S\014\215\004\001\277\017\342\356H\247\n\022\021\333\005\304\340";
    PyObject *data = __Pyx_DecompressString(cstring, 449, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (390 bytes) */
const char* const cstring = "x\332UP\273N\3030\024m\253\002E @\200:\002\3455\026\001\022+\342\261\260\240\002\037p\3458.Xq\354\324vh\203@t\314\230\261c\306\214\214|F\307\214\375\204~\0027my-\327\307\276\347\236s|\31757\336\021\205\342h\006Q\017\240\205\245\025]sj\341\226\365\354=k\023\023I\312U\223*\255B\313%3\304j\010\250\245O\214z\340j\322uUW\202\340>\267T \001\270\004\253\te\016\241\036U~\020Z\006n$\211\317)\030\376\302\345\343\367\253\307\204\210\240\215d\313\225\244\241\326LZp\210 \2222\200v()\000p\003?\356\3342\337\374\037\003\360\t\237\324\036\270n\021\255@\305\237\246\241\260\243\334P\240\036\000\206\3003`\304\373v\tT\000\320\t\211\230\266&\253\230n\004\3000;\233@\344\342.B\201j\226\031\254\317D\204\314t\321X(c@\023\214R\334\020\260~y\264\265=\256\225\346j\375\267\344*\351\344\265\325\2703\252\326\023?=\031\036\234}8\237\345\274\272\3207\361^|7\351\345\325\245\370\030\247\366\366\307k\245\271\355\341V3s>\312#\344\274&\247\303\372a\352d\345\274V\237\241\361|\241\334\213M\322\230)\357\244\313\331eF\376\310\254\024\224\367\204\0166\007\017\351b\266\221]\314\250\233\311\365\2402h\344\010n\260UIw\323\213\302H\307\353\361\361o\230/v\212\3236";
    PyObject *data = __Pyx_DecompressString(cstring, 390, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (539 bytes) */
const char* const bytes = "?risk/c_risk.pyx__Pyx_PyDict_NextRefasyncio.coroutinesatr_pctcheck_drawdown_limitcline_in_tracebackcompute_dynamic_sizingcompute_kelly_fractioncurrent_balance__func___is_coroutineitemskelly_fraction__main__max_dd_pctmax_risk_limit__module____name__peak_balancepop__qualname__risk.c_risk__set_name__setdefault__test__valueswin_loss_ratiowin_rate\200\001\340\036\037\360\010\000\005\010\200}\220C\220q\330\010\017\210q\340\004\026\220m\2402\320%6\260b\270\001\330\004\007\200s\210#\210Q\330\010\017\210q\330\004\013\2101\200\001\340#$\360\020\000\005\037\320\036.\250b\260\001\340\004\007\200|\2203\320\026&\240b\250\001\330\010\026\320\026&\240b\250\001\360\006\000\005\010\200x\210s\220!\330\010\017\210q\340\004 \240\014\250B\250a\330\004\013\2101\200\001\340#$\360\016\000\005\010\200\177\220c\230\024\230S\240\t\250\023\250A\330\010\017\210q\340\004\024\220D\230\002\230!\330\004\024\220I\230S\240\002\240\"\240A\340\004\007\200r\210\022\2101\330\010\017\210q\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_win_rate, __pyx_mstate->__pyx_n_u_win_loss_ratio};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_risk_c_risk_pyx, __pyx_mstate->__pyx_n_u_compute_kelly_fraction, __pyx_mstate->__pyx_kp_b_iso88591_c_S_A_q_D_IS_A_r_1_q_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {4, 0, 0, 4, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 25};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_current_balance, __pyx_mstate->__pyx_n_u_kelly_fraction, __pyx_mstate->__pyx_n_u_max_risk_limit, __pyx_mstate->__pyx_n_u_atr_pct};
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_risk_c_risk_pyx, __pyx_mstate->__pyx_n_u_compute_dynamic_sizing, __pyx_mstate->__pyx_kp_b_iso88591_b_3_b_b_xs_q_Ba_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 3, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 47};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_peak_balance, __pyx_mstate->__pyx_n_u_current_balance, __pyx_mstate->__pyx_n_u_max_dd_pct};
    __pyx_mstate_global->__pyx_codeobj_tab[2] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_risk_c_risk_pyx, __pyx_mstate->__pyx_n_u_check_drawdown_limit, __pyx_mstate->__pyx_kp_b_iso88591_Cq_q_m2_6b_s_Q_q_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[2])) goto bad;
  }
